...
class _HomeApiClient implements HomeApiClient {
  ...
  @override
  Future<GetAllCategoriesResponseModel> getCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllCategoriesResponseModel>(
    ...
    late GetAllCategoriesResponseModel _value;
    try {
      _value = GetAllCategoriesResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
